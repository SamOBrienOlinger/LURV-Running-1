...
A Code Institute frontend exercise for a fictional Dublin running community.

**HTML · CSS**

[Visit the website](https://samobrienolinger.github.io/LURV-Running-1/) · [Getting started](#getting-started) · [Repository guide](#repository-guide) · [Checks](#checks-and-review) · [Credits](#credits-and-reuse)

## What you can explore

- Running-club introduction and weekly meetup information.
- A separate photo gallery.
- Responsive layout built with HTML and CSS.

> **Project notes:** Club events and meeting information are demonstration content from a learning project.
...
Repository maintained in [Sam O’Brien-Olinger’s GitHub account](https://github.com/SamOBrienOlinger). For a problem or suggested improvement, [open an issue](https://github.com/SamOBrienOlinger/LURV-Running-1/issues) with the affected page or command, steps to reproduce, and expected behaviour.

[Back to top](#love-running)
